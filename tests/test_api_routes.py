...
def test_full_api_flow():
    ...
    res = client.post(f'/requests/{req_id}/assign', json={'assigned_rider_id': 4, 'changed_by': 2})
    ...
    invalid_deliv_payload = {'status': 'Delivered', 'changed_by': 3, 'confirmation_code': 'RX-999999'}
    ...
    valid_deliv_payload = {'status': 'Delivered', 'changed_by': 3, 'confirmation_code': code}
